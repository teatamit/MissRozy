...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=ajak4405_{str_to_b64(str(SaveMessage.id))}"
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ Open Link ⚡️", url=share_link)],
                 [InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/anumitultrabots"),
                  InlineKeyboardButton("🍿supp⊕rt gr⊕up", url="https://t.me/anumitultrabots")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
        ...
        # ✧ source code upgraded by The sir anumitultrabots 
        # ✧ Don't remove credit ✧ @anumitultrabots ✧
        if(Config.LAZY_MODE == True):
            ...
            caption_z = f"{file_name}\n\n༺ᴊᴏɪɴ @{lazypost_channel_username} ༻\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @{lazypost_ch_admin_usrnm} \n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/anumitultrabots'>⎝⎝✧ʟᴀᴢʏᴅᴇᴠᴇʟᴏᴘᴇʀ✧⎠⎠</a>"
            caption_za = f"{file_name}\n\n༺ᴊᴏɪɴ @{lazypost_channel_username} ༻\n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/anumitultrabots'>⎝⎝✧ʟᴀᴢʏᴅᴇᴠᴇʟᴏᴘᴇʀ✧⎠⎠</a>"
            caption_zab = f"{file_name}\n\n🦋・‥☆𝘼𝘿𝙈𝙞𝙉 𝙨𝙪𝙥𝙥𝙤𝙧𝙩☆‥・🦋\n╰┈➤・☆ @{lazypost_ch_admin_usrnm} \n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/anumitultrabots'>⎝⎝✧ʟᴀᴢʏᴅᴇᴠᴇʟᴏᴘᴇʀ✧⎠⎠</a>"
            caption_zabi = f"{file_name}\n\n+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/anumitultrabots'>⎝⎝✧ʟᴀᴢʏᴅᴇᴠᴇʟᴏᴘᴇʀ✧⎠⎠</a>"
            lazy_dev = f"+> ᴛʜᴀɴᴋ ʏᴏᴜ <a href='https://telegram.me/anumitultrabots'>⎝⎝✧ʟᴀᴢʏᴅᴇᴠᴇʟᴏᴘᴇʀ✧⎠⎠</a>"
            ...
            if(Config.LP_CUSTOM_TEMPLATE):
                ...
                # ✧ Please don't add unnescesary things here >[anumitultrabots]
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        await forwarded_msg.reply_text(
            ...
            disable_web_page_preview=True)
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=ajak4405_{str_to_b64(file_er_id)}"
        await editable.edit(
        ...
        if(Config.LAZY_MODE == True):
            ...
            # ✧ Here is the condition for sending POST in movie channel ✧ anumitultrabots ✧
            if(Config.LP_CUSTOM_TEMPLATE):
                await bot.send_photo(lazy_channel,photo=location,caption=lazypost_custom_template,reply_markup=reply_markup)
            elif(Config.LP_CUSTOM_TEMPLATE and Config.LP_BTN_MAIN_CH_USRNM):
                await bot.send_photo(lazy_channel,photo=location,caption=lazypost_custom_template,reply_markup=main_btn)
